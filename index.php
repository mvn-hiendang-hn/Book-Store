...
<html lang="en">
  ...
  <body>
    ...
    <header class="header">
      <a href="#" class="logo"> <i class="fas fa-shopping-basket"></i> Book Store </a>
    ...
    <section class="products" id="products">
      <h1 class="heading">nội dung <span>sản phẩm AI gợi ý</span></h1>
      <!-- slider1 -->
      <div class="swiper product-slider">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide box">
            ...
            <div class="price">
              <?php echo $row_product['price_product'] ?>VND
            </div>
            <div class="stars">
    ...
    <section class="footer">
      ...
      <div class="credit">
        created by <span> Đặng Thanh Hiền  </span>
      </div>
    </section>
    <!-- footer section ends -->
